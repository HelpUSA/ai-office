# AI Office + Pizza App - Synthetic Fixture Plan
...
This Synthetic Fixture Plan artifact keeps the Pizza App readonly snapshot work in a docs-only and smoke-only phase. Pizza App remains the source of truth. AI Office consumes approved readonly snapshots only after explicit manual approval gate completion.
...
- no production queue payload
- readonly_snapshot_v1_synthetic.json
